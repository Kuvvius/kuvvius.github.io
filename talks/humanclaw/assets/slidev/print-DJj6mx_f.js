import{C as e,L as t,b as n,g as r,h as i,mt as a,p as o,v as s,vt as c,x as l,y as u,z as d}from"../modules/shiki-BiiZU2CK.js";import{x as f}from"../modules/vue-DfL2g-Wl.js";import{Ot as p,_ as m,yt as h}from"../index-DwXPypoU.js";import{t as g}from"./NoteDisplay-Ty-A1IdV.js";var _={id:`page-root`},v={class:`m-4`},y={class:`mb-10`},b={class:`text-4xl font-bold mt-2`},x={class:`opacity-50`},S={class:`text-lg`},C={class:`font-bold flex gap-2`},w={class:`opacity-50`},T={key:0,class:`border-main mb-8`},E=e({__name:`print`,setup(e){let{slides:E,total:D}=m();f(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
